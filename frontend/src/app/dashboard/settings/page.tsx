            ...
            <div className={styles['container']}>
                ...
                <div className={styles['card']}>
                    <p style={{ color: '#ef4444' }}>
                        Failed to load user profile. Please try refreshing or logging in again.
                    </p>
                </div>
            </div>
        );
    ...
    return (
        <div className={styles['container']}>
            <header>
                ...
                <p className={styles['subtitle']}>Manage your personal account information.</p>
            </header>
                ...
                <div className={styles['section']} style={{ marginBottom: 0 }}>
                    ...
                    <div style={{ display: 'flex', gap: '0.5rem', flexWrap: 'wrap' }}>
                        {user.permissions && user.permissions.length > 0 ? (
                            ...
                            <span className={styles['roleTag']} style={{ background: 'rgba(255, 255, 255, 0.1)', color: '#a1a1aa', border: 'none' }}>
